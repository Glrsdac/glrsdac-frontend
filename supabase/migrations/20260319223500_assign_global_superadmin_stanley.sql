-- Migration: Assign global superadmin role to stanleyyeboah754@gmail.com
-- Date: 2026-03-19
...
BEGIN
  SELECT id INTO superadmin_user_id FROM auth.users WHERE email = 'stanleyyeboah754@gmail.com';
